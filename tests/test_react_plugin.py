...
class TestReactLanguagePlugin(unittest.TestCase):
    ...
    def test_can_handle_react_errors(self):
        ...
        framework_error = {"framework": "react", "message": "Some React error"}
...
"""
    ...
    def test_fix_missing_dependency(self):
        ...
        analysis = {"root_cause": "react_missing_dependency", "category": "react"}
        source_code = """
function MyComponent() {
...
"""
    ...
    def test_fix_missing_key_prop(self):
        ...
        analysis = {"root_cause": "react_missing_key_prop", "category": "react"}
        source_code = """
...
"""
    ...
    def test_fix_jsx_scope_error(self):
        ...
        error_data = {"message": "'React' must be in scope when using JSX"}
        analysis = {"root_cause": "react_jsx_scope_error", "category": "react"}
        source_code = """
function App() {
...
"""
    ...
    def test_fix_redux_store_connection(self):
        ...
        error_data = {"message": "Cannot read property 'getState' of undefined"}
        analysis = {"root_cause": "redux_store_not_connected", "category": "react"}
        source_code = """
function App() {
    return <MyComponent />;
}
"""
    ...
    def test_fix_context_provider_missing(self):
        ...
        error_data = {"message": "useContext must be used within a ThemeProvider"}
        analysis = {"root_cause": "context_provider_missing", "category": "react"}
        source_code = """
function MyComponent() {
...
"""
    ...
    def test_performance_error_detection(self):
        ...
        self.assertIn(
            "performance", analysis.get("tags", []) or analysis.get("subcategory", "")
        )
    ...
    def test_server_component_error_detection(self):
        ...
        self.assertIn(
            "server", analysis.get("tags", []) or analysis.get("subcategory", "")
        )
