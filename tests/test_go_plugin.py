...
from modules.analysis.plugins.go_plugin import GoLanguagePlugin, GoPatchGenerator
...
class TestGoErrorAdapter:
    ...
    def test_to_standard_format_deadlock(self):
        ...
        go_error = {
            ...
            "goroutines": [
                {"id": 1, "state": "chan receive", "location": "main.go:20"},
                {"id": 2, "state": "chan send", "location": "worker.go:35"},
            ],
        }
...
class TestGoExceptionHandler:
    ...
    def test_analyze_nil_pointer_dereference(self):
        ...
        error_data = {
            "error_type": "Panic",
            "message": "runtime error: invalid memory address or nil pointer dereference",
            "stack_trace": [{"function": "processUser", "file": "user.go", "line": 30}],
        }
    ...
    def test_analyze_index_out_of_range(self):
        ...
        error_data = {
            ...
            "stack_trace": [{"function": "getElement", "file": "array.go", "line": 15}],
        }
...
class TestGoLanguagePlugin:
    ...
    def test_framework_detection_gin(self):
        ...
        error_data = {
            ...
            "stack_trace": [
                {
                    "function": "github.com/gin-gonic/gin.(*Context).Next",
                    "file": "context.go",
                }
            ],
        }
    ...
    def test_framework_detection_echo(self):
        ...
        error_data = {
            ...
            "stack_trace": [
                {
                    "function": "github.com/labstack/echo/v4.(*Echo).ServeHTTP",
                    "file": "echo.go",
                }
            ],
        }
...
class TestGoFrameworkSpecific:
    ...
    def test_fiber_error(self):
        ...
        error_data = {
            ...
            "stack_trace": [
                {
                    "function": "github.com/gofiber/fiber/v2.(*App).next",
                    "file": "router.go",
                }
            ],
        }
...
class TestGoEdgeCases:
    ...
    def test_goroutine_leak_detection(self):
        ...
        error_data = {
            ...
            "stack_summary": {
                "total": 1000,
                "states": {"chan receive": 950, "IO wait": 50},
            },
        }
...
class TestGoPerformanceAndSecurity:
    ...
    def test_memory_leak_detection(self):
        ...
        error_data = {
            ...
            "metrics": {"heap_alloc": "500MB", "num_gc": 1000},
        }
