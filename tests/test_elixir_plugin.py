...
class TestElixirPlugin(unittest.TestCase):
    ...
    def test_normalize_error(self):
        ...
        self.assertEqual(
            standard_error["message"], 'key :missing_key not found in: %{foo: "bar"}'
        )
        ...
        self.assertEqual(
            denormalized["message"], 'key :missing_key not found in: %{foo: "bar"}'
        )
    ...
    def test_integration(self):
        ...
        self.assertEqual(fix["root_cause"], "elixir_key_error")
        self.assertTrue(
            "Map.get" in fix["suggestion"]
            or "Map.get" in fix.get("suggestion_code", "")
        )
