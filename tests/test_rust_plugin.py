...
from modules.analysis.plugins.rust_plugin import RustLanguagePlugin, RustErrorHandler, RustPatchGenerator
...
class TestRustPlugin(unittest.TestCase):
    ...
    def test_error_normalization(self):
        ...
        self.assertEqual(standard_error["message"], "thread 'main' panicked at 'called `Option::unwrap()` on a `None` value', src/main.rs:15:13")
    ...
    def test_error_denormalization(self):
        ...
        self.assertEqual(rust_error["message"], "thread 'main' panicked at 'called `Option::unwrap()` on a `None` value', src/main.rs:15:13")
    ...
    def test_fix_generation_unwrap_none(self):
        ...
        context = {
            "code_snippet": "let value = optional.unwrap();"
        }
    ...
    def test_fix_generation_index_out_of_bounds(self):
        ...
        context = {
            "code_snippet": "let value = array[index];"
        }
