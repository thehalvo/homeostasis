...
class TestKotlinErrorAdapter:
    ...
    def test_to_standard_format_android_error(self):
        ...
        kotlin_error = {
            ...
            "android": {"api_level": 33, "device": "Pixel 6"},
...
class TestKotlinExceptionHandler:
    ...
    def test_analyze_coroutine_cancellation(self):
        ...
        error_data = {
            ...
            "stack_trace": [
                "at kotlinx.coroutines.JobSupport.cancel(JobSupport.kt:123)"
            ],
        }
    ...
    def test_analyze_room_main_thread_error(self):
        ...
        error_data = {
            ...
            "stack_trace": [
                "at androidx.room.RoomDatabase.assertNotMainThread(RoomDatabase.kt:123)"
            ],
        }
    ...
    def test_analyze_android_fragment_error(self):
        ...
        error_data = {
            ...
            "stack_trace": [
                "at androidx.fragment.app.Fragment.requireContext(Fragment.kt:123)"
            ],
        }
    ...
    def test_analyze_compose_recomposition_loop(self):
        ...
        error_data = {
            ...
            "stack_trace": [
                "at androidx.compose.runtime.Recomposer.recompose(Recomposer.kt:123)"
            ],
        }
...
class TestKotlinPatchGenerator:
    ...
    def test_generate_null_safety_patch(self):
        ...
        context = {"code_snippet": "user.name.length", "framework": ""}
    ...
    def test_generate_coroutine_patch(self):
        ...
        analysis = {
            ...
            "error_data": {"error_type": "CancellationException"},
    ...
    def test_generate_room_patch(self):
        ...
        analysis = {
            ...
            "error_data": {"error_type": "IllegalStateException"},
    ...
    def test_generate_compose_patch(self):
        ...
        analysis = {
            ...
            "error_data": {"error_type": "StateNotRemembered"},
...
class TestKotlinLanguagePlugin:
    ...
    def test_generate_fix(self):
        ...
        analysis = {
            "rule_id": "kotlin_null_pointer_exception",
            "root_cause": "kotlin_null_pointer",
            "error_data": {"error_type": "KotlinNullPointerException"},
...
class TestKotlinIntegrationScenarios:
    ...
    def test_coroutine_timeout_scenario(self):
        ...
        error_data = {
            ...
            "coroutine": {"name": "NetworkCall", "dispatcher": "IO"},
        }
