...
class TestHealingRateLimiter(unittest.TestCase):
    ...
    def test_file_cooldown(self):
        ...
        self.rate_limiter.place_file_in_cooldown(test_file, 1)  # 1 second cooldown for test
    ...
    def test_reset_counters(self):
        ...
        self.assertEqual(self.rate_limiter.action_counts["patch_application"]["global"], 0)
        self.assertEqual(self.rate_limiter.action_counts["deployment"]["global"], 0)
        self.assertEqual(self.rate_limiter.action_counts["file"]["test_file.py"]["default"], 0)
    ...
    def test_get_usage_stats(self):
        ...
        self.assertEqual(len(stats["top_files"]), 2)  # test_file.py and critical_file.py
