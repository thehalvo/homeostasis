...
class TestErlangPatchGenerator:
    ...
    def test_generate_syntax_fix(self):
        ...
        error_data = {"message": "syntax error before: ')'", "file_path": "test.erl"}
    ...
    def test_generate_function_fix(self):
        ...
        assert (
            "function" in function_patch["description"].lower()
            or "clause" in function_patch["description"].lower()
        )

    def test_generate_pattern_fix(self):
        """Test generation of pattern match fixes."""
        error_data = {"message": "no case clause matching", "file_path": "test.erl"}
        ...
        assert (
            "pattern" in pattern_patch["description"].lower()
            or "case" in pattern_patch["description"].lower()
        )
    ...
    def test_generate_otp_fix(self):
        ...
        assert (
            "gen_server" in otp_patch["description"].lower()
            or "otp" in otp_patch["description"].lower()
        )
    ...
    def test_generate_process_fix(self):
        ...
        assert (
            "process" in process_patch["description"].lower()
            or "exception" in process_patch["description"].lower()
        )
    ...
    def test_generate_module_fix(self):
        ...
        assert (
            "module" in module_patch["description"].lower()
            or "function" in module_patch["description"].lower()
        )

    def test_generate_compilation_fix(self):
        """Test generation of compilation fixes."""
        error_data = {"message": "head mismatch", "file_path": "test.erl"}
        ...
        assert (
            "compilation" in compilation_patch["description"].lower()
            or "mismatch" in compilation_patch["description"].lower()
        )
