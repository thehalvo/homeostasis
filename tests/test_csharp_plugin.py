...
class TestCSharpPlugin(unittest.TestCase):
    ...
    def test_error_normalization(self):
        ...
        self.assertEqual(standard_error["message"], "Object reference not set to an instance of an object")
        ...
        if isinstance(standard_error["stack_trace"][0], dict):
            ...
            self.assertEqual(first_frame["file"], "D:\\Projects\\MyApp\\Services\\UserService.cs")
    ...
    def test_denormalization(self):
        ...
        self.assertEqual(csharp_error["exception_type"], "System.NullReferenceException")
        self.assertEqual(csharp_error["message"], "Object reference not set to an instance of an object")
        self.assertEqual(csharp_error["dotnet_version"], "6.0.16")
        self.assertEqual(csharp_error["framework"], "ASP.NET Core")
        self.assertEqual(csharp_error["level"], "Error")  # Note: capitalized in C# format
        
        # Check stack trace conversion
        self.assertIsInstance(csharp_error["stack_trace"], str)
        self.assertIn("at MyCompany.MyApp.Services.UserService.GetUserProfile", csharp_error["stack_trace"])
    ...
    def test_error_analysis_db_update(self):
        ...
        # Check analysis results
        self.assertEqual(analysis["error_type"], "Microsoft.EntityFrameworkCore.DbUpdateException")
    ...
    def test_error_analysis_task_canceled(self):
        ...
        # Check analysis results
        self.assertEqual(analysis["error_type"], "System.Threading.Tasks.TaskCanceledException")
    ...
    def test_cross_platform_conversion(self):
        ...
        with patch('modules.analysis.language_adapters.ErrorAdapterFactory.get_adapter') as mock_adapter:
            # Mock Python adapter
...
class TestCSharpStackTraceParsing(unittest.TestCase):
    ...
    def test_parse_standard_stack_trace(self):
        ...
        self.assertEqual(frames[0]["file"], "D:\\Projects\\MyApp\\Services\\UserService.cs")
        ...
        self.assertEqual(frames[1]["file"], "D:\\Projects\\MyApp\\Controllers\\UserController.cs")
    ...
    def test_parse_lambda_stack_trace(self):
        ...
        self.assertEqual(lambda_frame["file"], "D:\\Projects\\MyApp\\Services\\DataService.cs")
    ...
    def test_convert_frames_to_stack(self):
        ...
        stack_trace = self.adapter._convert_frames_to_csharp_stack(error_type, message, frames)
        
        # Check the formatted stack trace
        self.assertTrue(stack_trace.startswith(f"{error_type}: {message}"))
        self.assertIn("at MyCompany.MyApp.Services.UserService.GetUserProfile(Int32 userId) in D:\\Projects\\MyApp\\Services\\UserService.cs:line 42", stack_trace)
        self.assertIn("at MyCompany.MyApp.Controllers.UserController.GetProfile(Int32 id) in D:\\Projects\\MyApp\\Controllers\\UserController.cs:line 28", stack_trace)
