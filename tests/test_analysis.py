...
from modules.analysis.rule_config import Rule, load_rule_configs
...
def test_analyze_errors_rule_based():
    ...
    with patch(
        "modules.analysis.rule_based.RuleBasedAnalyzer.analyze_error",
...
def test_analyze_errors_ai_based():
    ...
    with patch(
        ...
        with patch(
            "modules.analysis.ai_stub.AIAnalyzer.analyze_error",
...
def test_analyze_errors_mixed_results():
    ...
    with patch(
        "modules.analysis.rule_based.RuleBasedAnalyzer.analyze_error",
        side_effect=mock_rule_results,
    ):
        with patch(
            "modules.analysis.ai_stub.AIAnalyzer.analyze_error",
            side_effect=mock_ai_results,
        ):
            analyzer = Analyzer(use_ai=True)
