...
class TestNextjsPlugin(unittest.TestCase):
    ...
    def test_can_handle(self):
        ...
        self.assertTrue(self.plugin.can_handle({
    ...
    def test_analyze_data_fetching_error(self):
        ...
        result = self.exception_handler.analyze_data_fetching_error(self.getserversideprops_error)
    ...
    def test_rule_loading(self):
        ...
        self.assertGreater(len(self.exception_handler.rules.get("data_fetching", [])), 0)
