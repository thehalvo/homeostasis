...
class TestFSharpPatchGenerator:
    ...
    def test_generate_computation_expression_fix(self):
        ...
        assert (
            "computation" in computation_patch["description"].lower()
            or "bind" in computation_patch["description"].lower()
        )
    ...
    def test_generate_union_fix(self):
        ...
        assert (
            "union" in union_patch["description"].lower()
            or "argument" in union_patch["description"].lower()
        )
    ...
    def test_generate_import_fix(self):
        ...
        assert (
            "namespace" in import_patch["description"].lower()
    ...
    def test_generate_null_reference_fix(self):
        ...
        assert (
            "null" in null_patch["description"].lower()
            or "reference" in null_patch["description"].lower()
        )
