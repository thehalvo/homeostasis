...
class TestPowerShellPatchGenerator:
    ...
    def test_generate_permission_fix(self):
        ...
        assert (
            ...
            or "access" in permission_patch["description"].lower()
        )
    ...
    def test_generate_module_fix(self):
        ...
        assert (
            ...
            or "import" in module_patch["description"].lower()
        )
    ...
    def test_generate_type_fix(self):
        ...
        assert (
            ...
            or "convert" in type_patch["description"].lower()
        )
    ...
    def test_generate_pipeline_fix(self):
        ...
        assert (
            "pipeline" in pipeline_patch["description"].lower()
            or "parameter" in pipeline_patch["description"].lower()
        )
