...
class TestJavaExceptionHandler:
    ...
    def test_analyze_deadlock_error(self):
        ...
        assert (
            "deadlock" in analysis["root_cause"] or "monitor" in analysis["root_cause"]
        )
        assert analysis["category"] == "concurrency"
    ...
    def test_analyze_hibernate_lazy_loading(self):
        ...
        error_data = {
            ...
            "stack_trace": [
                {"class": "AbstractPersistentCollection", "function": "initialize"}
            ],
        }
...
class TestJavaPatchGenerator:
    ...
    def test_generate_null_check_patch(self):
        ...
        context = {"code_snippet": "int length = str.length();", "variable_name": "str"}
    ...
    def test_generate_concurrent_collection_patch(self):
        ...
        analysis = {
            ...
            "error_data": {"error_type": "java.util.ConcurrentModificationException"},
...
class TestJavaLanguagePlugin:
    ...
    def test_generate_fix_for_concurrent_modification(
        self, java_plugin, error_data_concurrent
    ):
    ...
    def test_rule_loading(self):
        ...
        assert any(
            rule["id"] == "java_concurrent_modification" for rule in handler.rules
        )
...
class TestJavaPerformanceAndSecurityErrors:
    ...
    def test_analyze_security_exception(self):
        ...
        error_data = {
            ...
            "stack_trace": [
                {"class": "SecurityManager", "function": "checkPermission"}
            ],
        }
...
class TestJavaEdgeCases:
            ...
            "suppressed": [
                {
                    ...
                    "stacktrace": [
                        "at java.io.FileInputStream.close(FileInputStream.java:300)"
                    ],
                }
            ],
        }
    ...
    def test_parse_compilation_error_with_multiple_issues(self):
        ...
        java_error = {
            "type": "CompilationError",
            "errors": [
                {"file": "Main.java", "line": 10, "message": "';' expected"},
                {"file": "Main.java", "line": 15, "message": "cannot find symbol"},
            ],
        }
...
class TestJavaIntegration:
    ...
    def test_framework_detection_in_error_analysis(self):
        ...
        test_cases = [
            ...
            {"error_type": "play.api.PlayException", "expected_framework": "play"},
            {
