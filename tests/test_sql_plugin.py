...
class TestSQLPatchGenerator:
    ...
    def test_generate_constraint_fix(self):
        ...
        assert (
            "constraint" in constraint_patch["description"].lower()
            or "unique" in constraint_patch["description"].lower()
        )
    ...
    def test_generate_join_fix(self):
        ...
        assert (
            "ambiguous" in join_patch["description"].lower()
            or "qualify" in join_patch["description"].lower()
        )
    ...
    def test_generate_type_fix(self):
        ...
        assert (
            ...
            or "cast" in type_patch["description"].lower()
        )
    ...
    def test_generate_permission_fix(self):
        ...
        assert (
            ...
            or "grant" in permission_patch["description"].lower()
        )
    ...
    def test_generate_index_fix(self):
        ...
        assert (
            "duplicate" in index_patch["description"].lower()
            or "unique" in index_patch["description"].lower()
        )
    ...
    def test_generate_connection_fix(self):
        ...
        assert (
            "connection" in connection_patch["description"].lower()
            or "database" in connection_patch["description"].lower()
        )
