        ...
        for batch in range(num_batches):
            errors = [
                self.generate_random_error(
                    random.choice(["python", "javascript", "java"])
                )
        ...
        for _ in range(100):
            error = {
                ...
                "code_context": {
                    "ast": {
                        "type": "Module",
                        "body": [{"type": "FunctionDef"} for _ in range(100)],
                    },
                    "variables": {
                        f"var_{i}": {
                            "type": "complex",
                            "value": [j for j in range(100)],
                        }
                        for i in range(50)
                    },
                    "call_graph": {
                        f"func_{i}": [f"func_{j}" for j in range(i)] for i in range(50)
                    },
                },
            }
