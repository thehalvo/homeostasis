...
class TestScalaPlugin(unittest.TestCase):
    ...
    def test_error_normalization(self):
        ...
        self.assertEqual(standard_error["message"], "Cannot invoke \"String.length()\" because \"str\" is null")
    ...
    def test_match_error_analysis(self):
        ...
        self.assertIn("exhaustive", analysis["suggestion"])  # Should suggest exhaustive matches
        self.assertEqual(analysis["confidence"], "high")
