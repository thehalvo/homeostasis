...
class USHSClient:
    ...
    async def start_session(self, error_id: str, policy: Optional[str] = None,
    ...
    async def submit_patch(self, session_id: str, patch: HealingPatch) -> Dict[str, Any]:
    ...
    async def validate_patch(self, patch_id: str, tests: Optional[List[str]] = None,
    ...
    async def deploy_patch(self, patch_id: str, strategy: DeploymentStrategy,
                         environment: str, approvals: Optional[List[Dict[str, str]]] = None) -> Dict[str, Any]:
        """Deploy a patch"""
        await self._ensure_session()
    ...
    async def connect_websocket(self, subscribe: Optional[List[str]] = None,
    ...
    async def subscribe(self, event_types: List[str], filters: Optional[Dict[str, Any]] = None):
...
async def example_usage():
    ...
    async with USHSClient(
        base_url="https://api.example.com/ushs/v1",
