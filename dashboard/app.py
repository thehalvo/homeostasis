    ...
    def _register_routes(self) -> None:
        ...
        def suggestions(error_id):
            ...
            for suggestion in suggestions:
                diff_html = generate_diff(suggestion.original_code, suggestion.suggested_code)
        ...
        def rule_editor(rule_id):
            ...
            selected_template = next((t for t in templates if t['id'] == rule.get('template_id')), None)
        ...
        def template_editor(template_id):
            ...
            parent_template = next((t for t in parent_templates if t['id'] == template.get('parent_id')), None)
            ...
            ] if template.get('id') == 'template-001' else []
        ...
        def login():
            if request.method == 'POST':
                ...
                if self.auth_manager:
                    ...
                    if user:
                        # Generate token
                        access_token, refresh_token = self.auth_manager.generate_token(user)
