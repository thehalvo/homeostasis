...
def process_medical_billing(patient_id, procedure_codes, insurance_info):
    ...
    print(f"\nHealthcare:")
    print(f"  Validation Pass Rate: {healthcare_dash['validation_metrics']['pass_rate']:.1f}%")
    print(f"  Total Validations: {healthcare_dash['validation_metrics']['total_validations']}")
    
    financial_dash = governance.get_industry_dashboard(RegulatedIndustry.FINANCIAL_SERVICES)
    print(f"\nFinancial Services:")
    print(f"  Validation Pass Rate: {financial_dash['validation_metrics']['pass_rate']:.1f}%")
    print(f"  Total Validations: {financial_dash['validation_metrics']['total_validations']}")
