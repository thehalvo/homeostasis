...
/**
 * Java-specific inspection that integrates with Homeostasis healing
 */
class JavaHealingInspection : LocalInspectionTool() {
    
    companion object {
        private val LOG = Logger.getInstance(JavaHealingInspection::class.java)
    }
    ...
    override fun buildVisitor(holder: ProblemsHolder, isOnTheFly: Boolean): PsiElementVisitor {
        return object : PsiElementVisitor() {
            override fun visitFile(file: PsiFile) {
                if (file.language.id.lowercase() != "java") {
                    return
                }
                ...
                try {
                    ...
                    LOG.error("Error during Java inspection", e)
                }
            }
        }
    }
    ...
    private fun registerSuggestion(holder: ProblemsHolder, file: PsiFile, suggestion: HealingSuggestion) {
        ...
        if (startElement != null && endElement != null) {
            ...
            if (suggestion.replacement != null) {
                fixes.add(JavaHomeostasisQuickFix(suggestion))
            }
    ...
    /**
     * Quick fix implementation for Java Homeostasis suggestions
     */
    private inner class JavaHomeostasisQuickFix(private val suggestion: HealingSuggestion) : LocalQuickFix {
        
        override fun getName(): String = "Apply Homeostasis Fix: ${suggestion.description}"
        
        override fun getFamilyName(): String = "Homeostasis Java Healing"
