...
/**
 * JavaScript-specific inspection that integrates with Homeostasis healing
 */
class JavaScriptHealingInspection : LocalInspectionTool() {
    
    companion object {
        private val LOG = Logger.getInstance(JavaScriptHealingInspection::class.java)
    }
    ...
    override fun buildVisitor(holder: ProblemsHolder, isOnTheFly: Boolean): PsiElementVisitor {
        return object : PsiElementVisitor() {
            override fun visitFile(file: PsiFile) {
                ...
                if (languageId != "javascript" && languageId != "jsx") {
                    return
                }
                ...
                try {
                    ...
                    LOG.error("Error during JavaScript inspection", e)
                }
            }
        }
    }
    ...
    private fun registerSuggestion(holder: ProblemsHolder, file: PsiFile, suggestion: HealingSuggestion) {
        ...
        if (startElement != null && endElement != null) {
            ...
            if (suggestion.replacement != null) {
                fixes.add(JavaScriptHomeostasisQuickFix(suggestion))
            }
    ...
    /**
     * Quick fix implementation for JavaScript Homeostasis suggestions
     */
    private inner class JavaScriptHomeostasisQuickFix(private val suggestion: HealingSuggestion) : LocalQuickFix {
        
        override fun getName(): String = "Apply Homeostasis Fix: ${suggestion.description}"
        
        override fun getFamilyName(): String = "Homeostasis JavaScript Healing"
