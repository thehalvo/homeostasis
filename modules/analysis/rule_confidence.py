...
class ConfidenceScorer:
    ...
    def score_match(
        ...
        rule_match.pattern_quality_score = ConfidenceScorer._calculate_pattern_quality(
            rule
        )
    ...
    def _calculate_context_score(
        ...
        if (
            "exception_type" in error_context and
    ...
    def _calculate_specificity_score(
        rule: Union[Rule, EnhancedRule], match: re.Match
    ) -> float:
        """
...
class RuleMatchRanker:
    ...
    def filter_low_confidence(
        matches: List[RuleMatch], min_score: float = 0.5
    ) -> List[RuleMatch]:
        """
...
class ContextualRuleAnalyzer:
    ...
    def analyze_error(
        ...
        result = {
            ...
            "match_groups": (
                best_match.match.groups() if best_match.match.groups() else None
            ),
