...
class JavaScriptExceptionHandler:
        ...
        try:
            ...
            if common_rules_path.exists():
                with open(common_rules_path, 'r') as f:
                    ...
                    logger.info(f"Loaded {len(rules['common'])} common JavaScript rules")
    ...
    def analyze_transpilation_error(self, error_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        # TypeScript errors
        if "typescript" in message.lower() or "tsc" in message.lower() or error_type.startswith("TS"):
    ...
    def _analyze_babel_error(self, message: str, error_data: Dict[str, Any]) -> Dict[str, Any]:
    ...
    def _analyze_typescript_error(self, message: str, error_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        type_error_patterns = {
            "2304": {
                ...
                "commands": ["Verify imports", "Check type definitions", "Install @types packages if needed"]
            },
            "2322": {
                "pattern": "Type .* is not assignable to type",
                "fix": "Fix type mismatch by adjusting types or using type assertions",
                "commands": ["Check type compatibility", "Use type assertions if necessary", "Update type definitions"]
            },
            "2339": {
                "pattern": "Property .* does not exist on type",
                "fix": "Check if property exists or extend the type definition",
                "commands": ["Verify property names", "Extend interfaces", "Use optional chaining"]
            },
            "2307": {
                "pattern": "Cannot find module",
                "fix": "Install missing module or add type definitions",
                "commands": ["npm install <module>", "npm install --save-dev @types/<module>", "Check import paths"]
            }
        }
    ...
    def _analyze_webpack_error(self, message: str, error_data: Dict[str, Any]) -> Dict[str, Any]:
    ...
    def _analyze_rollup_error(self, message: str, error_data: Dict[str, Any]) -> Dict[str, Any]:
    ...
    def _analyze_vite_error(self, message: str, error_data: Dict[str, Any]) -> Dict[str, Any]:
    ...
    def _analyze_parcel_error(self, message: str, error_data: Dict[str, Any]) -> Dict[str, Any]:
...
class JavaScriptPatchGenerator:
    ...
    def _load_templates(self) -> Dict[str, str]:
        ...
        if not self.js_template_dir.exists():
            logger.warning(f"JavaScript templates directory not found: {self.js_template_dir}")
            return templates
    ...
    def _fix_property_access(self, error_data: Dict[str, Any], analysis: Dict[str, Any], 
                           source_code: str) -> Optional[Dict[str, Any]]:
    ...
    def _fix_not_a_function(self, error_data: Dict[str, Any], analysis: Dict[str, Any], 
                          source_code: str) -> Optional[Dict[str, Any]]:
    ...
    def _fix_undefined_reference(self, error_data: Dict[str, Any], analysis: Dict[str, Any], 
                               source_code: str) -> Optional[Dict[str, Any]]:
    ...
    def _fix_promise_rejection(self, error_data: Dict[str, Any], analysis: Dict[str, Any], 
                             source_code: str) -> Optional[Dict[str, Any]]:
        ...
        if ".then(" in problem_line and ".catch(" not in problem_line:
            fixed_line = problem_line.rstrip() + ".catch(error => console.error('Promise rejected:', error));"
    ...
    def _fix_memory_issue(self, error_data: Dict[str, Any], analysis: Dict[str, Any], 
                        source_code: str) -> Optional[Dict[str, Any]]:
    ...
    def _fix_async_operation(self, error_data: Dict[str, Any], analysis: Dict[str, Any], 
                           source_code: str) -> Optional[Dict[str, Any]]:
...
class JavaScriptLanguagePlugin(LanguagePlugin):
    ...
    def _is_transpilation_error(self, error_data: Dict[str, Any]) -> bool:
        ...
        transpilation_patterns = [
            "babel", "typescript", "tsc", "webpack", "rollup", "vite", "parcel"
        ]
    ...
    def analyze_dependency_error(self, error_data: Dict[str, Any], project_path: str) -> Dict[str, Any]:
        ...
        """
        try:
            return self.dependency_analyzer.analyze_dependency_error(error_data, project_path)
        except Exception as e:
    ...
    def analyze_error(self, error_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            if self._is_dependency_error(standard_error):
                project_path = standard_error.get("context", {}).get("project_path", ".")
                analysis = self.dependency_analyzer.analyze_dependency_error(standard_error, project_path)
            
            # Check if it's a transpilation error  
            elif self._is_transpilation_error(standard_error):
                analysis = self.exception_handler.analyze_transpilation_error(standard_error)
