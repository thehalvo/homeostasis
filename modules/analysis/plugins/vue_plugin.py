...
class VueExceptionHandler:
        ...
        try:
            ...
            if component_rules_path.exists():
                with open(component_rules_path, 'r') as f:
                    ...
                    logger.info(f"Loaded {len(rules['components'])} Vue component rules")
            ...
            if composition_rules_path.exists():
                with open(composition_rules_path, 'r') as f:
                    ...
                    logger.info(f"Loaded {len(rules['composition'])} Vue Composition API rules")
        ...
        for category, rule_list in self.rules.items():
            ...
            for rule in rule_list:
                try:
                    ...
                    logger.warning(f"Invalid regex pattern in Vue rule {rule.get('id', 'unknown')}: {e}")
    ...
    def analyze_composition_api_error(self, error_data: Dict[str, Any]) -> Dict[str, Any]:
        """
...
class VuePatchGenerator:
    ...
    def _load_templates(self) -> Dict[str, str]:
        ...
        if not self.vue_template_dir.exists():
            logger.warning(f"Vue templates directory not found: {self.vue_template_dir}")
            return templates
    ...
    def _fix_ref_access_before_init(self, error_data: Dict[str, Any], analysis: Dict[str, Any], 
                                   source_code: str) -> Optional[Dict[str, Any]]:
    ...
    def _fix_ref_not_defined(self, error_data: Dict[str, Any], analysis: Dict[str, Any], 
                            source_code: str) -> Optional[Dict[str, Any]]:
...
export default {
  setup() {
    ...
    def _fix_computed_not_defined(self, error_data: Dict[str, Any], analysis: Dict[str, Any], 
                                 source_code: str) -> Optional[Dict[str, Any]]:
...
export default {
  setup() {
    ...
    def _fix_watch_not_defined(self, error_data: Dict[str, Any], analysis: Dict[str, Any], 
                              source_code: str) -> Optional[Dict[str, Any]]:
...
export default {
  setup() {
    ...
    def _fix_lifecycle_not_defined(self, error_data: Dict[str, Any], analysis: Dict[str, Any], 
                                  source_code: str) -> Optional[Dict[str, Any]]:
        """Fix undefined lifecycle hook imports."""
        message = error_data.get("message", "")
        
        # Extract lifecycle hook name
        lifecycle_match = re.search(r"(onMounted|onUpdated|onUnmounted|onBeforeMount|onBeforeUpdate|onBeforeUnmount)", message, re.IGNORECASE)
...
export default {{
  setup() {{
    ...
    def _fix_setup_return_type(self, error_data: Dict[str, Any], analysis: Dict[str, Any], 
                              source_code: str) -> Optional[Dict[str, Any]]:
  ...
  setup() {
    ...
    def _fix_vuex_store_not_imported(self, error_data: Dict[str, Any], analysis: Dict[str, Any], 
                                    source_code: str) -> Optional[Dict[str, Any]]:
...
export default store"""
    ...
    def _fix_vuex_undefined_mutation(self, error_data: Dict[str, Any], analysis: Dict[str, Any], 
                                    source_code: str) -> Optional[Dict[str, Any]]:
  ...
  {mutation_name}(state, payload) {{
    ...
    def _fix_vuex_direct_state_mutation(self, error_data: Dict[str, Any], analysis: Dict[str, Any], 
                                       source_code: str) -> Optional[Dict[str, Any]]:
...
mutations: {
  setCount(state, value) {
    ...
    def _fix_router_not_imported(self, error_data: Dict[str, Any], analysis: Dict[str, Any], 
                                source_code: str) -> Optional[Dict[str, Any]]:
...
export default router"""
    ...
    def _fix_route_not_found(self, error_data: Dict[str, Any], analysis: Dict[str, Any], 
                            source_code: str) -> Optional[Dict[str, Any]]:
...
class VueLanguagePlugin(LanguagePlugin):
    ...
    def __init__(self):
        ...
        self.supported_frameworks = [
            "vue", "vue3", "nuxt", "vite-vue", "vue-cli",
            "quasar", "vuepress", "gridsome"
        ]
    ...
    def _is_vuex_error(self, error_data: Dict[str, Any]) -> bool:
        ...
        return any(pattern in message or pattern in stack_trace for pattern in vuex_patterns)
