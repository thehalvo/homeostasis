        ...
        try:
            ...
            if reactivity_rules_path.exists():
                with open(reactivity_rules_path, 'r') as f:
                    ...
                    logger.info(f"Loaded {len(rules['reactivity'])} Svelte reactivity rules")
        ...
        for category, rule_list in self.rules.items():
            ...
            for rule in rule_list:
                try:
                    ...
                    logger.warning(f"Invalid regex pattern in Svelte rule {rule.get('id', 'unknown')}: {e}")
...
class SveltePatchGenerator:
    ...
    def _load_templates(self) -> Dict[str, str]:
        ...
        if not self.svelte_template_dir.exists():
            logger.warning(f"Svelte templates directory not found: {self.svelte_template_dir}")
            return templates
    ...
    def _fix_reactive_infinite_loop(self, error_data: Dict[str, Any], analysis: Dict[str, Any], 
                                   source_code: str) -> Optional[Dict[str, Any]]:
...
$: if (someCondition) {
  tempInput = result + 1;
    ...
    def _fix_reactive_undefined_variable(self, error_data: Dict[str, Any], analysis: Dict[str, Any], 
                                        source_code: str) -> Optional[Dict[str, Any]]:
  ...
  $: doubledCount = count * 2;
    ...
    def _fix_reactive_access_before_init(self, error_data: Dict[str, Any], analysis: Dict[str, Any], 
                                        source_code: str) -> Optional[Dict[str, Any]]:
  ...
  $: processedData = isLoaded ? processData(data) : null;
    ...
    def _fix_store_not_imported(self, error_data: Dict[str, Any], analysis: Dict[str, Any], 
                               source_code: str) -> Optional[Dict[str, Any]]:
...
export const myStore = {store_type}(initialValue);"""
    ...
    def _fix_store_subscription_leak(self, error_data: Dict[str, Any], analysis: Dict[str, Any], 
                                    source_code: str) -> Optional[Dict[str, Any]]:
  ...
  onDestroy(() => {
    ...
    def _fix_sveltekit_load_return_type(self, error_data: Dict[str, Any], analysis: Dict[str, Any], 
                                       source_code: str) -> Optional[Dict[str, Any]]:
...
export async function load({ params, url, fetch }) {
  try {
    ...
    def _fix_sveltekit_goto_ssr_error(self, error_data: Dict[str, Any], analysis: Dict[str, Any], 
                                     source_code: str) -> Optional[Dict[str, Any]]:
  ...
  onMount(() => {
    ...
    def _fix_sveltekit_hydration_mismatch(self, error_data: Dict[str, Any], analysis: Dict[str, Any], 
                                         source_code: str) -> Optional[Dict[str, Any]]:
...
{/if}"""
    ...
    def _fix_transition_error(self, error_data: Dict[str, Any], analysis: Dict[str, Any], 
                             source_code: str) -> Optional[Dict[str, Any]]:
...
{/if}"""
    ...
    def _fix_binding_error(self, error_data: Dict[str, Any], analysis: Dict[str, Any], 
                          source_code: str) -> Optional[Dict[str, Any]]:
...
class SvelteLanguagePlugin(LanguagePlugin):
    ...
    def __init__(self):
        ...
        self.supported_frameworks = [
            "svelte", "sveltekit", "@sveltejs/kit", "vite-svelte",
            "rollup-svelte", "webpack-svelte", "svelte-native"
        ]
    ...
    def analyze_error(self, error_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            # Check if it's a SvelteKit error
                ...
                analysis = self.exception_handler.analyze_sveltekit_error(standard_error)
    ...
    def _is_store_error(self, error_data: Dict[str, Any]) -> bool:
        ...
        return any(pattern in message or pattern in stack_trace for pattern in store_patterns)
    ...
    def _is_sveltekit_error(self, error_data: Dict[str, Any]) -> bool:
        ...
        return any(pattern in message or pattern in stack_trace for pattern in sveltekit_patterns)
