...
class CrystalExceptionHandler:
    ...
    def _analyze_crystal_concepts(self, message: str) -> Dict[str, Any]:
        ...
        if any(keyword in message_lower for keyword in ["nil", "null", "null reference"]):
            return {
                "category": "crystal",
                "subcategory": "nil",
                "confidence": "high",
...
class CrystalPatchGenerator:
    ...
    def _load_templates(self) -> Dict[str, str]:
        ...
        if not self.crystal_template_dir.exists():
            logger.warning(f"Crystal templates directory not found: {self.crystal_template_dir}")
            return templates
    ...
    def _fix_macro_error(self, error_data: Dict[str, Any], analysis: Dict[str, Any], 
                        source_code: str) -> Optional[Dict[str, Any]]:
    ...
    def _fix_fiber_error(self, error_data: Dict[str, Any], analysis: Dict[str, Any], 
                        source_code: str) -> Optional[Dict[str, Any]]:
    ...
    def _fix_method_error(self, error_data: Dict[str, Any], analysis: Dict[str, Any], 
                         source_code: str) -> Optional[Dict[str, Any]]:
    ...
    def _fix_nil_error(self, error_data: Dict[str, Any], analysis: Dict[str, Any], 
                      source_code: str) -> Optional[Dict[str, Any]]:
    ...
    def _fix_pointer_error(self, error_data: Dict[str, Any], analysis: Dict[str, Any], 
                          source_code: str) -> Optional[Dict[str, Any]]:
    ...
    def _fix_channel_error(self, error_data: Dict[str, Any], analysis: Dict[str, Any], 
                          source_code: str) -> Optional[Dict[str, Any]]:
    ...
    def _fix_struct_error(self, error_data: Dict[str, Any], analysis: Dict[str, Any], 
                         source_code: str) -> Optional[Dict[str, Any]]:
...
class CrystalLanguagePlugin(LanguagePlugin):
    ...
    def __init__(self):
        ...
        self.supported_frameworks = [
            "crystal", "shards", "kemal", "amber", "lucky", "athena"
        ]
