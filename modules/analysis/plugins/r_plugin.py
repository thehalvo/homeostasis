...
class RExceptionHandler:
    ...
    def _analyze_r_concepts(self, message: str) -> Dict[str, Any]:
        ...
        if any(keyword in message_lower for keyword in ["column", "undefined", "selected"]):
            return {
                "category": "r",
                "subcategory": "dataframe",
                "confidence": "medium",
        ...
        if any(keyword in message_lower for keyword in ["package", "library", "namespace"]):
            return {
                "category": "r",
                "subcategory": "package",
                "confidence": "medium",
        ...
        if any(keyword in message_lower for keyword in ["function", "argument", "unused"]):
            return {
                "category": "r",
                "subcategory": "function",
                "confidence": "medium",
...
class RPatchGenerator:
    ...
    def _fix_data_error(self, error_data: Dict[str, Any], analysis: Dict[str, Any], 
                       source_code: str) -> Optional[Dict[str, Any]]:
    ...
    def _fix_package_error(self, error_data: Dict[str, Any], analysis: Dict[str, Any], 
                          source_code: str) -> Optional[Dict[str, Any]]:
    ...
    def _fix_model_error(self, error_data: Dict[str, Any], analysis: Dict[str, Any], 
                        source_code: str) -> Optional[Dict[str, Any]]:
    ...
    def _fix_vector_error(self, error_data: Dict[str, Any], analysis: Dict[str, Any], 
                         source_code: str) -> Optional[Dict[str, Any]]:
    ...
    def _fix_dataframe_error(self, error_data: Dict[str, Any], analysis: Dict[str, Any], 
                            source_code: str) -> Optional[Dict[str, Any]]:
    ...
    def _fix_object_not_found_error(self, error_data: Dict[str, Any], analysis: Dict[str, Any], 
                                   source_code: str) -> Optional[Dict[str, Any]]:
