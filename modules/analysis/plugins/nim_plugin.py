...
class NimExceptionHandler:
    ...
    def _analyze_nim_concepts(self, message: str) -> Dict[str, Any]:
        ...
        if any(keyword in message_lower for keyword in ["nil", "nilaccessdefect", "null"]):
            return {
                "category": "nim",
                "subcategory": "nil_access",
                "confidence": "high",
...
class NimPatchGenerator:
    ...
    def _load_templates(self) -> Dict[str, str]:
        ...
        if not self.nim_template_dir.exists():
            logger.warning(f"Nim templates directory not found: {self.nim_template_dir}")
            return templates
    ...
    def _fix_proc_error(self, error_data: Dict[str, Any], analysis: Dict[str, Any], 
                       source_code: str) -> Optional[Dict[str, Any]]:
