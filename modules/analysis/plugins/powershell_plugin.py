...
class PowerShellExceptionHandler:
    ...
    def __init__(self):
        ...
        self.powershell_error_patterns = {
            "syntax_error": [
                r"UnexpectedToken",
                r"Unexpected token",
                r"MissingEndCurlyBrace",
                r"MissingEndParenthesis",
                r"MissingEndSquareBracket",
                r"MissingExpression",
                r"MissingFunctionBody",
                r"MissingOpenParenthesisInFunctionParameterList",
                r"MissingCloseParenthesisInFunctionParameterList",
            ],
            "cmdlet_error": [
                r"CommandNotFoundException",
                r"ParameterNotFound",
                r"AmbiguousParameterSet",
                r"MissingMandatoryParameter",
                r"ParameterArgumentValidationError",
                r"InvalidOperation",
                r"MethodNotFound",
                r"PropertyNotFound",
                r"not recognized as a cmdlet",
                r"not recognized as the name",
            ],
            "pipeline_error": [
                r"PipelineStoppedException",
                r"InvalidPipelineInput",
                r"ObjectNotFound",
                r"FormatError",
                r"ConvertError",
    ...
    def analyze_exception(self, error_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if re.search(
            r"The variable.*cannot be retrieved|VariableNotFound|UndefinedVariable|Cannot find a variable",
            message,
            re.IGNORECASE,
        ):
            return {
        ...
        if re.search(
            r"Cannot convert|TypeMismatch|InvalidArgument|InvalidCastException|Cannot convert value to type",
            message,
            re.IGNORECASE,
        ):
            return {
