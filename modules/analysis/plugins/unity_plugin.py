...
class UnityErrorAdapter:
    ...
    def to_standard_format(self, unity_error: Dict[str, Any]) -> Dict[str, Any]:
        ...
        error_type = unity_error.get("condition", unity_error.get("error_type", "Exception"))
        ...
        return {
            ...
            "log_type": log_type,
            "unity_object": unity_error.get("object"),  # Unity object that caused the error
...
class UnityExceptionHandler:
        ...
        try:
            ...
            if scripting_rules_path.exists():
                with open(scripting_rules_path, 'r') as f:
                    ...
                    logger.info(f"Loaded {len(rules['scripting'])} Unity scripting rules")
            else:
                rules["scripting"] = []
                    
        except Exception as e:
            logger.error(f"Error loading Unity rules: {e}")
            rules = {"common": self._create_default_rules(), "mobile": [], "scripting": []}
        ...
        for category, rule_list in self.rules.items():
            ...
            for rule in rule_list:
                try:
                    ...
                    logger.warning(f"Invalid regex pattern in Unity rule {rule.get('id', 'unknown')}: {e}")
    ...
    def _generic_analysis(self, error_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if "nullreferenceexception" in error_type.lower():
            ...
            category = "unknown"
            suggestion = "Review Unity implementation and check Unity Console for more details"
...
class UnityPatchGenerator:
    ...
    def _load_templates(self) -> Dict[str, str]:
        ...
        if not self.unity_template_dir.exists():
            logger.warning(f"Unity templates directory not found: {self.unity_template_dir}")
            return templates
        ...
        for template_name, template_content in default_templates.items():
            ...
            if not template_path.exists():
                try:
                    ...
                    logger.error(f"Error creating default Unity template {template_name}: {e}")
...
"""
    ...
    def _fix_missing_component(self, error_data: Dict[str, Any], analysis: Dict[str, Any], 
                              source_code: str) -> Optional[Dict[str, Any]]:
...
"""
    ...
    def _fix_destroyed_object(self, error_data: Dict[str, Any], analysis: Dict[str, Any], 
                             source_code: str) -> Optional[Dict[str, Any]]:
...
"""
    ...
    def _fix_mobile_build(self, error_data: Dict[str, Any], analysis: Dict[str, Any], 
                         source_code: str) -> Optional[Dict[str, Any]]:
    ...
    def _fix_ui_null_reference(self, error_data: Dict[str, Any], analysis: Dict[str, Any], 
                              source_code: str) -> Optional[Dict[str, Any]]:
    ...
    def _fix_android_gradle(self, error_data: Dict[str, Any], analysis: Dict[str, Any], 
                           source_code: str) -> Optional[Dict[str, Any]]:
    ...
    def _fix_ios_xcode(self, error_data: Dict[str, Any], analysis: Dict[str, Any], 
                      source_code: str) -> Optional[Dict[str, Any]]:
...
class UnityLanguagePlugin(LanguagePlugin):
    ...
    def __init__(self):
        ...
        self.supported_frameworks = [
            "unity", "unity3d", "unityengine", "unity.mobile",
    ...
    def can_handle(self, error_data: Dict[str, Any]) -> bool:
        ...
        if any(indicator in project_files_str for indicator in unity_project_indicators):
            return True
    ...
    def analyze_error(self, error_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            # Check if it's a Unity scripting error
                ...
                analysis = self.exception_handler.analyze_scripting_error(standard_error)
    ...
    def _is_mobile_build_error(self, error_data: Dict[str, Any]) -> bool:
        ...
        return (any(pattern in message for pattern in mobile_patterns) or
                "mobile" in platform or "android" in build_target or "ios" in build_target)
    ...
    def _is_scripting_error(self, error_data: Dict[str, Any]) -> bool:
        ...
        return any(pattern in message or pattern in stack_trace or pattern in error_type.lower() 
