...
class SwiftExceptionHandler:
    ...
    def _load_rules(self) -> Dict[str, List[Dict[str, Any]]]:
        ...
        try:
            ...
            rules = {"common": [], "uikit": [], "swiftui": [], "coredata": [], "concurrency": []}
    ...
    def analyze_fatal_error(self, error_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if "unexpectedly found nil while unwrapping an optional value" in message.lower():
            return {
                "category": "fatal",
...
class SwiftPatchGenerator:
    ...
    def _load_templates(self) -> Dict[str, str]:
        ...
        if not self.swift_template_dir.exists():
            logger.warning(f"Swift templates directory not found: {self.swift_template_dir}")
            return templates
    ...
    def _fix_array_bounds(self, error_data: Dict[str, Any], analysis: Dict[str, Any], 
                         source_code: str) -> Optional[Dict[str, Any]]:
        ...
        if match:
            ...
            fixed_line = problem_line.replace(f"{array_name}[{index_expr}]", safe_access)
    ...
    def _fix_retain_cycle(self, error_data: Dict[str, Any], analysis: Dict[str, Any], 
                         source_code: str) -> Optional[Dict[str, Any]]:
    ...
    def _fix_main_thread(self, error_data: Dict[str, Any], analysis: Dict[str, Any], 
                        source_code: str) -> Optional[Dict[str, Any]]:
    ...
    def _fix_core_data_context(self, error_data: Dict[str, Any], analysis: Dict[str, Any], 
                              source_code: str) -> Optional[Dict[str, Any]]:
    ...
    def _fix_async_await(self, error_data: Dict[str, Any], analysis: Dict[str, Any], 
                        source_code: str) -> Optional[Dict[str, Any]]:
    ...
    def _fix_swiftui_state(self, error_data: Dict[str, Any], analysis: Dict[str, Any], 
                          source_code: str) -> Optional[Dict[str, Any]]:
...
class SwiftLanguagePlugin(LanguagePlugin):
    ...
    def __init__(self):
        ...
        self.supported_frameworks = [
            "uikit", "swiftui", "foundation", "core_data", "core_animation",
            "avfoundation", "mapkit", "core_location", "healthkit", "homekit",
            "cloudkit", "gameplaykit", "scenekit", "metal", "core_ml"
        ]
    ...
    def can_handle(self, error_data: Dict[str, Any]) -> bool:
        ...
        runtime = error_data.get("runtime", "").lower()
        if any(platform in runtime for platform in ["ios", "macos", "watchos", "tvos", "swift"]):
            return True
