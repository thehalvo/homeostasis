...
class AngularExceptionHandler:
        ...
        try:
            ...
            if di_rules_path.exists():
                with open(di_rules_path, "r") as f:
                    ...
                    logger.info(
                        f"Loaded {len(rules['dependency_injection'])} Angular DI rules"
                    )
        ...
        for category, rule_list in self.rules.items():
            ...
            for rule in rule_list:
                try:
                    ...
                    logger.warning(
                        f"Invalid regex pattern in Angular rule {rule.get('id', 'unknown')}: {e}"
                    )
    ...
    def analyze_dependency_injection_error(
    ...
    def analyze_template_binding_error(
        self, error_data: Dict[str, Any]
    ) -> Dict[str, Any]:
        """
...
class AngularPatchGenerator:
    ...
    def _load_templates(self) -> Dict[str, str]:
        ...
        if not self.angular_template_dir.exists():
            logger.warning(
                f"Angular templates directory not found: {self.angular_template_dir}"
            )
            return templates
...
export class {service_name} {{ }}""",
    ...
    def _fix_injection_token_error(
        self, error_data: Dict[str, Any], analysis: Dict[str, Any], source_code: str
    ) -> Optional[Dict[str, Any]]:
...
export class ServiceB {
  constructor(@Inject(forwardRef(() => ServiceA)) private serviceA: ServiceA) {}
    ...
    def _fix_cannot_resolve_parameters(
        self, error_data: Dict[str, Any], analysis: Dict[str, Any], source_code: str
    ) -> Optional[Dict[str, Any]]:
...
export class YourService {
  constructor(
    ...
    def _fix_ngrx_store_not_provided(
        self, error_data: Dict[str, Any], analysis: Dict[str, Any], source_code: str
    ) -> Optional[Dict[str, Any]]:
...
export const loadItemsFailure = createAction(
  ...
  props<{ error: any }>()
    ...
    def _fix_ngrx_reducer_undefined(
        self, error_data: Dict[str, Any], analysis: Dict[str, Any], source_code: str
    ) -> Optional[Dict[str, Any]]:
...
export const itemReducer = createReducer(
  ...
  on(ItemActions.loadItemsFailure, (state, { error }) => ({ 
    ...
    def _fix_template_property_undefined(
        self, error_data: Dict[str, Any], analysis: Dict[str, Any], source_code: str
    ) -> Optional[Dict[str, Any]]:
...
ngOnInit() {
  this.user = this.user || {};
    ...
    def _fix_invalid_property_binding(
        self, error_data: Dict[str, Any], analysis: Dict[str, Any], source_code: str
    ) -> Optional[Dict[str, Any]]:
...
class AngularLanguagePlugin(LanguagePlugin):
    ...
    def can_handle(self, error_data: Dict[str, Any]) -> bool:
        ...
        if re.search(
            r"@angular|angular\.json|ng\s|\.component\.|\.service\.|\.module\.",
            stack_trace,
        ):
            return True
        ...
        if any(
            "@angular" in dep or "angular" in dep or "ngrx" in dep
    ...
    def analyze_error(self, error_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            if self._is_dependency_injection_error(standard_error):
                analysis = self.exception_handler.analyze_dependency_injection_error(
                    standard_error
                )
            ...
            # Check if it's a template binding error
                ...
                analysis = self.exception_handler.analyze_template_binding_error(
                    standard_error
                )
    ...
    def _is_ngrx_error(self, error_data: Dict[str, Any]) -> bool:
        ...
        return any(
            pattern in message or pattern in stack_trace for pattern in ngrx_patterns
        )
