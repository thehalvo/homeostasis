...
class AnnotationInterface:
    ...
    def get_next_task(
        self,
        annotator_id: str,
        task_types: Optional[List[AnnotationType]] = None
        ...
        for task in self.tasks.values():
            if (task.status == AnnotationStatus.PENDING and
    ...
    def submit_annotation(
        ...
        logger.info(f"Received annotation {annotation.annotation_id} for task {task_id}")
    ...
    def get_annotator_stats(self, annotator_id: str) -> Dict[str, Any]:
        ...
        return self.annotator_stats.get(annotator_id, {
            'total_annotations': 0,
            'avg_confidence': 0,
            'avg_time_taken': 0,
            'annotation_types': {},
    ...
    def _send_to_ml_feedback(self, task: AnnotationTask, annotations: List[Annotation]) -> None:
    ...
    def _update_annotator_stats(self, annotator_id: str, annotation: Annotation) -> None:
                ...
                with open(annotation_file, 'r') as f:
                    for line in f:
                        if line.strip():
                            ...
                            ann_data['annotation_type'] = AnnotationType(ann_data['annotation_type'])
...
class AnnotationQualityScorer:
    ...
    def select_training_data(
        ...
        filtered = [(ann, score) for ann, score in scored_annotations if score >= min_quality]
