...
class SelfHealingCurriculum:
    ...
    def _create_condensed_module(self, original: CourseModule) -> CourseModule:
        ...
        return CourseModule(
            ...
            activities=[a for a in original.activities if a["type"] in ["lab", "workshop"]],
            resources=original.resources,
            assessments=[{"type": "practical", "title": "Skills Assessment", "weight": 1.0}],
            prerequisites=[]
        )
    ...
    def _calculate_assessment_weights(
        self,
        module: CourseModule
    ) -> Dict[str, float]:
        ...
        for assessment in module.assessments:
            ...
            weight = assessment.get("weight", 0) / total_weight if total_weight > 0 else 0
            ...
            "structure": [
                {
                    ...
                    "activities": ["Review prerequisites", "Introduce topic", "State objectives"]
                },
                {
                    "phase": "Presentation",
                    "duration": duration_minutes // 3,
                    "activities": ["Present core concepts", "Show examples", "Demonstrate tools"]
                },
                {
                    "phase": "Practice",
                    "duration": duration_minutes // 3,
                    "activities": ["Guided practice", "Individual exercises", "Troubleshooting"]
                },
                {
                    "phase": "Assessment",
                ...
                },
                {
                    "phase": "Conclusion",
                    "duration": duration_minutes // 12,
                    "activities": ["Summarize key points", "Preview next topic", "Assign homework"]
                }
            ],
    ...
    def _suggest_materials(self, topic: str) -> List[str]:
        ...
        if "formal" in topic.lower() or "verification" in topic.lower():
            materials.extend(["Proof assistant software", "Formal specification examples"])
            ...
            "test_cases": [
                {
                    ...
                    "expected": [{"line": 2, "type": "ERROR", "message": "Database connection failed"}]
                }
            ],
            "hints": [
