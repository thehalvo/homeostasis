...
from modules.deployment.serverless.aws_lambda import (AWSLambdaProvider,
                                                      get_lambda_provider)
from modules.deployment.serverless.azure_functions import (
    AzureFunctionsProvider, get_azure_functions_provider)
...
from modules.deployment.serverless.gcp_functions import (
    GCPFunctionsProvider, get_functions_provider)
