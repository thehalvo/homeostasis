...
class GCPProvider(BaseCloudProvider):
        ...
        try:
            ...
            if trigger_type == "http":
                ...
                if not topic:
                    ...
                    return {"success": False, "error": "Topic name required for Pub/Sub trigger"}
    ...
    def _deploy_cloud_run(self, service_name: str, fix_id: str, 
                        source_path: str, **kwargs) -> Dict[str, Any]:
        ...
        if not image:
            ...
            return {"success": False, "error": "Image required for Cloud Run deployment"}
    ...
    def _deploy_gke(self, service_name: str, fix_id: str, 
                  source_path: str, **kwargs) -> Dict[str, Any]:
    ...
    def _undeploy_cloud_run(self, service_name: str, fix_id: str, **kwargs) -> Dict[str, Any]:
        ...
        return self._run_gcloud([
            "run", "services", "delete", service_identifier,
            "--project", self.project_id,
            "--region", self.location,
            "--platform", "managed",
            "--quiet"
    ...
    def get_service_status(self, service_name: str, fix_id: str, 
        ...
        if deployment_type == "function" and self.cloud_function_enabled:
            ...
            result = self._run_gcloud([
                "run", "services", "describe", service_identifier,
                "--project", self.project_id,
                "--region", self.location,
                "--platform", "managed"
            ])
