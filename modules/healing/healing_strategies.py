...
class RestartStrategy(Healer):
    ...
    def heal(
        self, error_analysis: Dict[str, Any], context: Dict[str, Any]
    ) -> HealingResult:
        """
...
class RollbackStrategy(Healer):
    ...
    def heal(
        ...
        try:
            ...
            logger.info(
                f"Rolling back {service_name} from {current_version} to {previous_version}"
            )
    ...
    def heal(
        ...
        try:
            ...
            return HealingResult(
                ...
                timestamp=datetime.now(),
                duration_seconds=duration,
                metadata={"service": service_name, "config_changes": config_changes},
            )
