...
class HealingActivityAuditor:
    ...
    def start_healing_session(
        ...
        log_event(
            ...
            user=user,
            details={"session_id": session_id, "trigger": trigger, **(details or {})},
        )
...
def log_error_detection(
    ...
    Args:
        ...
        details: Additional details about the error
    """
    get_healing_auditor().log_error_detection(
        session_id, error_id, error_type, source, details
    )
...
def log_error_analysis(
    ...
    Args:
        ...
        details: Additional details about the analysis
    """
    get_healing_auditor().log_error_analysis(
        session_id,
        error_id,
        analysis_type,
        root_cause,
...
def log_patch_generation(
    ...
    Args:
        ...
        details: Additional details about the patch
    """
    get_healing_auditor().log_patch_generation(
        session_id,
        error_id,
        fix_id,
        fix_type,
...
def log_patch_application(
    ...
    Args:
        ...
        details: Additional details about the application
    """
    get_healing_auditor().log_patch_application(
        session_id, fix_id, file_path, status, details
    )
...
def log_test_execution(
    ...
    Args:
        ...
        details: Additional details about the test
    """
    get_healing_auditor().log_test_execution(
        session_id, fix_id, test_type, status, duration_ms, details
    )
...
def log_deployment(
    ...
    Args:
        ...
        details: Additional details about the deployment
    """
    get_healing_auditor().log_deployment(
        session_id, fix_id, environment, status, deployment_type, user, details
    )
...
def log_human_interaction(
    ...
    Args:
        ...
        details: Additional details about the interaction
    """
    get_healing_auditor().log_human_interaction(
        session_id, fix_id, interaction_type, user, details
    )
