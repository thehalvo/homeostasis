...
class ErrorCollector:
    ...
    def _detect_error_bursts(self, errors: List[Dict[str, Any]], 
        ...
        for i in range(len(errors)):
            window_end_time = datetime.fromisoformat(errors[window_start]['collected_at']) + \
            ...
            if window_size >= threshold:
                ...
                bursts.append({
                    ...
                    'error_types': list(set(e.get('error_type', 'unknown') for e in burst_errors))
                })
...
def create_error_from_exception(e: Exception, context: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
    """
