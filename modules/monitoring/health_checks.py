...
class HealthChecker:
    ...
    def check_service_health(self, service_name: str, metrics: Dict[str, Any]) -> HealthStatus:
        """
        ...
        elif error_rate > 0.05 or response_time > 2000 or cpu_usage > 80 or memory_usage > 80:
