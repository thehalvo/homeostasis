...
class MonitoringLogger:
    ...
    def __init__(self, service_name: str, log_level: str = "INFO", 
                 log_file: Optional[Path] = None, include_system_info: bool = True,
    ...
    def log(self, level: str, message: str, include_call_location: bool = False, **kwargs) -> Dict[str, Any]:
        """
    ...
    def exception(self, e: Exception, include_locals: bool = True, 
                include_globals: bool = False, **kwargs) -> Dict[str, Any]:
        """
