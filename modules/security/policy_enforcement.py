...
from .compliance_reporting import get_compliance_reporting, ComplianceFramework
...
class PolicyEnforcementEngine:
    ...
    def evaluate_healing_action(self, context: PolicyEvaluationContext) -> List[PolicyEvaluationResult]:
    ...
    def enforce_healing_policy(self, context: PolicyEvaluationContext) -> Tuple[bool, Optional[str], Dict]:
        ...
        for result in results:
            if result.action == PolicyAction.DENY:
                return False, result.reason, {'policy_id': result.policy_id, 'violations': result.violations}
        
        # Check for REQUIRE_APPROVAL actions
        approval_required = [r for r in results if r.action == PolicyAction.REQUIRE_APPROVAL]
        ...
        quarantine_required = [r for r in results if r.action == PolicyAction.QUARANTINE]
    ...
    def create_policy(self, name: str, description: str, type: PolicyType,
                     scope: PolicyScope, rules: List[Dict],
        ...
        for rule_config in rules:
            ...
            rule = PolicyRule(
                ...
                priority=PolicyPriority(rule_config.get('priority', PolicyPriority.MEDIUM.value)),
    ...
    def update_policy(self, policy_id: str, updates: Dict, updated_by: str = "system") -> bool:
        ...
        new_policy = Policy(
            ...
            compliance_frameworks=updates.get('compliance_frameworks', policy.compliance_frameworks),
    ...
    def disable_policy(self, policy_id: str, reason: str, disabled_by: str = "system") -> bool:
        """Disable a policy.
    ...
    def get_policy_violations(self, start_date: datetime.datetime = None,
                            end_date: datetime.datetime = None,
                            policy_id: str = None) -> List[PolicyViolation]:
    ...
    def get_policy_metrics(self) -> Dict[str, Any]:
        ...
        open_violations = len([v for v in self.violations.values() 
        ...
        for policy in self.policies.values():
            if policy.enabled:
                policies_by_type[policy.type.value] = policies_by_type.get(policy.type.value, 0) + 1
    ...
    def _get_applicable_policies(self, context: PolicyEvaluationContext) -> List[Policy]:
        ...
        for policy in self.policies.values():
            ...
            elif policy.scope == PolicyScope.ENVIRONMENT and policy.metadata.get('environment') == context.environment:
                applicable.append(policy)
            elif policy.scope == PolicyScope.SERVICE and policy.metadata.get('service') == context.service_name:
                applicable.append(policy)
            elif policy.scope == PolicyScope.LANGUAGE and policy.metadata.get('language') == context.language:
                applicable.append(policy)
            elif policy.scope == PolicyScope.ERROR_TYPE and policy.metadata.get('error_type') == context.error_type:
                applicable.append(policy)
        
        return applicable
    
    def _evaluate_policy(self, policy: Policy, context: PolicyEvaluationContext) -> Optional[PolicyEvaluationResult]:
            ...
            if self._evaluate_rule(rule, context):
                ...
                if rule.action == PolicyAction.DENY:
                    for condition in rule.conditions:
                        violations.append(f"{condition.field} {condition.operator} {condition.value}")
    ...
    def _evaluate_rule(self, rule: PolicyRule, context: PolicyEvaluationContext) -> bool:
    ...
    def _evaluate_condition(self, condition: PolicyCondition, context: PolicyEvaluationContext) -> bool:
    ...
    def _evaluate_equals(self, field_value: Any, condition_value: Any, case_sensitive: bool) -> bool:
    ...
    def _evaluate_not_equals(self, field_value: Any, condition_value: Any, case_sensitive: bool) -> bool:
        """Evaluate not equals condition."""
        return not self._evaluate_equals(field_value, condition_value, case_sensitive)
    
    def _evaluate_contains(self, field_value: Any, condition_value: Any, case_sensitive: bool) -> bool:
    ...
    def _evaluate_regex(self, field_value: Any, condition_value: Any, case_sensitive: bool) -> bool:
    ...
    def _evaluate_greater_than(self, field_value: Any, condition_value: Any, case_sensitive: bool) -> bool:
    ...
    def _evaluate_less_than(self, field_value: Any, condition_value: Any, case_sensitive: bool) -> bool:
    ...
    def _evaluate_in(self, field_value: Any, condition_value: Any, case_sensitive: bool) -> bool:
    ...
    def _evaluate_not_in(self, field_value: Any, condition_value: Any, case_sensitive: bool) -> bool:
        """Evaluate not in condition."""
        return not self._evaluate_in(field_value, condition_value, case_sensitive)
    
    def _evaluate_starts_with(self, field_value: Any, condition_value: Any, case_sensitive: bool) -> bool:
    ...
    def _evaluate_ends_with(self, field_value: Any, condition_value: Any, case_sensitive: bool) -> bool:
    ...
    def _record_violation(self, policy: Policy, result: PolicyEvaluationResult, 
                         context: PolicyEvaluationContext):
        ...
        severity = severity_map.get(rule.priority if rule else PolicyPriority.MEDIUM, "medium")
    ...
    def _create_default_policies(self):
        ...
        hipaa_rules = [
            {
                ...
                'conditions': [
                    {
                        'field': 'service_name',
                        'operator': 'in',
                        'value': ['patient_service', 'medical_records', 'healthcare_api']
                    },
                    {
                        'field': 'patch_content',
                        'operator': 'regex',
                ...
                'priority': PolicyPriority.CRITICAL.value,
                'action_params': {
                    'approval_template': 'hipaa_compliance_review'
                }
            }
        ]
        ...
        self.create_policy(
            ...
            metadata={'services': ['patient_service', 'medical_records', 'healthcare_api']}
        )
                ...
                for policy_data in policies_data:
                    ...
                    for rule_data in policy_data['rules']:
                        ...
                        rule = PolicyRule(
                            ...
                            priority=PolicyPriority(rule_data.get('priority', PolicyPriority.MEDIUM.value)),
                    ...
                    policy = Policy(
                        ...
                        compliance_frameworks=[ComplianceFramework(f) for f in policy_data.get('compliance_frameworks', [])],
            ...
            with open(violations_file, 'r') as f:
                ...
                for violation_data in violations_data:
                    ...
                    violation = PolicyViolation(
                        ...
                        remediation_required=violation_data.get('remediation_required', False),
