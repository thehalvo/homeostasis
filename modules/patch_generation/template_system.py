...
class BaseTemplate:
    ...
    def __init__(self, name: str, content: Optional[str] = None, file_path: Optional[Path] = None, 
    ...
    def _extract_metadata(self) -> Dict[str, Any]:
        ...
        if app_match:
            ...
            metadata["applicability"] = [item.strip() for item in applicability.split(',')]
    ...
    def _extract_blocks(self) -> Dict[str, str]:
        ...
        """
        blocks = {
            "main": self._raw_content  # Default block is the entire content
        }
    ...
    def render(self, variables: Dict[str, str]) -> str:
        ...
        if "code_block" in variables and variables.get("preserve_indentation", "true").lower() == "true":
            ...
            if target_indent:
                ...
                if code_block:
                    try:
                        ...
                        result = adjust_indentation_for_context(normalized_result, code_block)
                    except Exception:
    ...
    def _substitute_variables(self, content: str, variables: Dict[str, str]) -> str:
        ...
        for var_name, var_value in variables.items():
            ...
            default_pattern = r'\{\{\s*' + re.escape(var_name) + r'\s*\|\s*default\s*:\s*"([^"]+)"\s*\}\}'
...
class TemplateManager:
    ...
    def _load_templates_from_dir(self, directory: Path, framework: Optional[str] = None) -> None:
        """
    ...
    def find_template_for_error(self, error_type: str, framework: Optional[str] = None) -> Optional[BaseTemplate]:
        """
